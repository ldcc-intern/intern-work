...
public class UserService {
    ...
    public Response createUser(UserRequest.CreateUserRequest createUserRequest) {
        ...
        return Response.ok().setData(user.getId());
    }

    @Transactional
    public Response getUserList() {
        List<User> users = userRepository.findAll();
        return Response.ok().setData(UserMapper.toUserListResponse(users));
    }
    ...
    public Response updateUser(Long userId, UserRequest.UpdateUserRequest updateUserRequest) {
        ...
        return Response.ok().setData(UserMapper.toUserUpdateResponse(user));
    }
